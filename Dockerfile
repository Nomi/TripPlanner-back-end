...
# Create the directory '/etc/TripPlannerAPI'
RUN mkdir -p /etc/TripPlannerAPI

## Optionally, you can change permissions on the directory
#RUN chmod -R 777 /etc/TripPlannerAPI
...
# Set permissions for the directory(/ies)
#RUN chown -R appuser:appuser /app
RUN chown -R appuser:appuser /etc/TripPlannerAPI
